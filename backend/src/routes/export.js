...
// Export PDF — returns HTML for client-side rendering (PDF is generated client-side via html2pdf.js)
router.get('/:resumeId/pdf', async (req, res) => {
  try {
    ...
    const html = generateResumeHTML(resume.resumeData, resume.templateId);
